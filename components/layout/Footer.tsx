...
const Footer = () => {
  ...
  return (
    <footer className="bg-bliss-blue lg:grid lg:grid-cols-5 text-black border-t-4 border-green">
      <div className="relative px-4 pt-16 lg:pb-16 sm:px-6 lg:col-span-3 lg:px-8">
        <div
          ...
          onClick={scrollToTop}
        >
          <a className="inline-block rounded-full bg-green p-2 text-orange shadow transition hover:green sm:p-3 lg:p-4">
              ...
              <form className="mt-6 w-full" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="rounded-md border border-white p-2 focus-within:ring flex flex-col sm:flex-row sm:items-center sm:gap-4">
                  ...
                  <button
                    ...
                    className="mt-1 w-full rounded bg-green px-6 py-3 text-sm font-bold uppercase tracking-wide text-beige transition hover:text-orange sm:mt-0 sm:w-auto sm:shrink-0"
                  >
        ...
        <div className="sm:mt-12 lg:pt-12">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="flex">
              <a
                href="https://www.linkedin.com/in/bart-ziolkowski/"
                target="_blank"
              >
                <p className="mt-8 text-lg sm:mt-0 me-4 transition hover:text-orange">
                  LinkedIn
                </p>
              </a>
              <a href="mailto:hello@bliss.com" target="_blank">
                <p className="mt-8 text-lg sm:mt-0 transition hover:text-orange">
                  E-mail
                </p>
              </a>
            </div>
            ...
            <p className="mt-8 text-lg sm:mt-0">
              &copy; 2024. Bliss. All rights reserved.
            </p>
          </div>
        </div>
      </div>
      <div className="relative block pb-16 lg:col-span-2 h-full w-full lg:border-l-2 border-beige font-museo-moderno text-center">
        <p className="text-12xl -mb-3">bliss</p>
        <p className="text-3xl w-full">Redefining Banking for Everyone</p>
      </div>
    </footer>
  );
};
